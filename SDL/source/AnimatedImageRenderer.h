...
public:
    AnimatedImageRenderer(int frameWidth=16, int frameHeight=16, int fps=30, int frames=2, bool looping=true, SDL_Color color={255,255,255,255}, float alpha=255, float rotation=0, SDL_Rect targetRect={0,0,16,16}, SDL_Rect sourceRect={0,0,16,16}, int cols=1, int rows=3)
